...
const getAllTransactionByUserID = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId: user_id } = req.user;
    const result = yield transaction_service_1.TransactionService.getAllTransactionByUserID(user_id);
